...
public class MinGeoDistanceAggregatorFactory extends ValuesSourceAggregatorFactory.LeafOnly<ValuesSource.GeoPoint> {

	private final GeoPoint origin;
	private final DistanceUnit unit;
	private final GeoDistance distanceType;
	
	protected MinGeoDistanceAggregatorFactory(String name, String type,
	...
	protected Aggregator createUnmapped(AggregationContext aggregationContext, Aggregator parent,
		...
		return new MinGeoDistanceAggregator(name, null, config.formatter(), aggregationContext, parent, pipelineAggregators, metaData);
	}
	...
	protected Aggregator doCreateInternal(ValuesSource.GeoPoint valuesSource, AggregationContext aggregationContext, Aggregator parent,
		...
		return new MinGeoDistanceAggregator(name, distanceSource, config.formatter(), aggregationContext, parent, pipelineAggregators, metaData);
	}
