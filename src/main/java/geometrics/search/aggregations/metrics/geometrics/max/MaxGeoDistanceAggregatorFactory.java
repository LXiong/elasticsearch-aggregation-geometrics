...
public class MaxGeoDistanceAggregatorFactory extends ValuesSourceAggregatorFactory.LeafOnly<ValuesSource.GeoPoint> {

	private final GeoPoint origin;
	private final DistanceUnit unit;
	private final GeoDistance distanceType;
	
	protected MaxGeoDistanceAggregatorFactory(String name, String type,
	...
	protected Aggregator createUnmapped(AggregationContext aggregationContext, Aggregator parent,
		...
		return new MaxGeoDistanceAggregator(name, null, config.formatter(), aggregationContext, parent, pipelineAggregators, metaData);
	}
	...
	protected Aggregator doCreateInternal(ValuesSource.GeoPoint valuesSource, AggregationContext aggregationContext, Aggregator parent,
		...
		return new MaxGeoDistanceAggregator(name, distanceSource, config.formatter(), aggregationContext, parent, pipelineAggregators, metaData);
	}
