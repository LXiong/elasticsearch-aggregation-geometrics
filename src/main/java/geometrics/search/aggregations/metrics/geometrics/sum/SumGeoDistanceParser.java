...
public class SumGeoDistanceParser extends GeoMetricsAggregatorParser {


	public SumGeoDistanceParser() {
		super(InternalSumGeoDistance.TYPE);
	}
	...
	protected AggregatorFactory createFactory(String aggregationName, ValuesSourceConfig<GeoPoint> config,
		...
		return new SumGeoDistanceAggregatorFactory(aggregationName, type(), config, origin, unit, distanceType);
	}
